...
package Underground8::Service::Virustotal;
...
use Underground8::Service::Virustotal::SLAVE;
...
sub new ($$)
{
    ...
    $self->{'_slave'} = new Underground8::Service::Virustotal::SLAVE();
...
sub commit
{
    ...
    my $files;
    push @{$files}, $g->{'file_virustotal_virustotalconf'};
